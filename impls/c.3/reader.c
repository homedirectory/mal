...
static MalDatum *read_atom(const char *token) {
    ...
    // symbol
        ...
        return (MalDatum*) MalDatum_symbol_get(token);
    }
    else {
...
MalDatum *read_form(Reader *rdr) {
    ...
    // quote macro
        ...
        List *list = List_new();
        List_add(list, (MalDatum*) MalDatum_symbol_get("quote"));
    ...
    // quasiquote macro
        ...
        List *list = List_new();
        List_add(list, (MalDatum*) MalDatum_symbol_get("quasiquote"));
        List_add(list, next_form);
        return MalDatum_new_list(list);
    }
    // splice-unquote macro
        ...
        List *list = List_new();
        List_add(list, (MalDatum*) MalDatum_symbol_get("splice-unquote"));
        List_add(list, next_form);
        return MalDatum_new_list(list);
    }
    // unquote macro
        ...
        List *list = List_new();
        List_add(list, (MalDatum*) MalDatum_symbol_get("unquote"));
        List_add(list, next_form);
        return MalDatum_new_list(list);
    }
    // atom
